// PHIÊN BẢN SCRIPT.JS HOÀN CHỈNH - CHO LAYOUT DRIBBBLE
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const searchInput = document.querySelector('.search-bar-new input'); // Cập nhật selector
        ...
        if (currentUser) {
            ...
            if (allowedRoles.includes(userType)) {
                ...
                if (dropdownMenuUl) {
                    ...
                    if (!dropdownMenuUl.querySelector('.report-link')) {
                        ...
                        if(divider) divider.insertAdjacentElement('afterend', reportLi);
                    }
    ...
    async function initializeApp() {
        ...
        updateProfileDropdown(); // Cập nhật thông tin user trên dropdown
        await fetchProducts();
